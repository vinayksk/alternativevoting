...
/**
 * Created by aweso on 5/26/2017. Pushes a ballot to a table.
 *
 * @author vinay
 * @version May 29, 2017
 * @author Period: 3
...
public class Voter extends HttpServlet
{
        ...
        HttpServletResponse response ) throws ServletException, IOException
    {
        ...
        for ( int i = 1; i <= num; i++ )
        {
            ...
            {
                list.add(
                    Integer.parseInt( request.getParameter( "vote" + i ) ) );
            }
            else
            {
        ...
        out.println(
            "<center><h1 style=\"font-family: 'Segoe UI Light'; font-size: 72px; padding-top: 15vh;\">Thank you for participating in <span style=\"color: #008CBA;\">"
                + electionName + "</span>.</h1>"
