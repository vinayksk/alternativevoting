...
public class backend
{
    ...
    public static void main( String[] args )
    {
        ...
        String url2 = String.format(
            "jdbc:postgresql://ugtzulvykibvoo:288db9b457f62a3f7333f910087e6d79f38bd205a3e47841596d2658a93cfdbb@ec2-54-163-254-76.compute-1.amazonaws.com:5432/dahhebb44gsieu" );
        ...
        try
        {
            ...
            //
            //// String fats = "insert into warowac1 (name, 1, 2, 3, 4) values
            // ('vote', 1, 3, 2, 4)";
