...
public class AlternativeElection
{
    ...
    private HashSet<ArrayList<Integer>> ballotset;


    public void AlternativeElection(
        ArrayList<String> candidates,
        HashSet<ArrayList<Integer>> ballotset )
    {
        this.candidates = new ArrayList<Candidate>();
        for ( String s : candidates )
        {
            this.candidates.add( new Candidate( s ) );
        }
        this.ballotset = ballotset;
    }


    public ArrayList<Candidate> iterate()
    {
        for ( ArrayList<Integer> ballot : ballotset )
        {
            Ballot b = new Ballot();
            set.add( b );
